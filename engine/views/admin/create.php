    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Invoice create</h1>
                        ...
                        <form action="/admin/createInvoice" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="date">
                                    ...
                                    <div class="input-group">
                                        <input type="text" autocomplete="off"  name="invoice" class="form-control" id="invoice">
                            ...
                            <div class="row">
                                <div class="col-md-6" id="date2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" autocomplete="off"  name="supply" class="form-control" id="supply">
                                        <div class="input-group-append">
